package bsu.pischule.csab.imdb.views.filmshistory;
...
@PageTitle("Films History")
@Route(value = "history/films", layout = MainLayout.class)
public class FilmsHistoryView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public FilmsHistoryView() {
        addClassName("films-history-view");
        setSizeFull();
        grid.setHeight("100%");
