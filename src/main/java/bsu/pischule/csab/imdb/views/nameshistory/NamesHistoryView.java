package bsu.pischule.csab.imdb.views.nameshistory;
...
@PageTitle("Names History")
@Route(value = "history/names", layout = MainLayout.class)
public class NamesHistoryView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public NamesHistoryView() {
        addClassName("names-history-view");
        setSizeFull();
        grid.setHeight("100%");
